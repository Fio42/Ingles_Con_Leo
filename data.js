...
const VOCAB_BANK = {
  facil: [
    { id:'v-facil-1', word:'Breakfast', translation:'Desayuno · comida de la mañana',
      ...
      quiz:{ prompt:"I always eat toast for ___.", options:["breakfast","dinner","lunch"], correct:0, explain:"“Breakfast” es la comida de la mañana." } },
    { id:'v-facil-2', word:'Neighbor', translation:'Vecino · alguien que vive cerca',
      ...
      quiz:{ prompt:"My ___ waters my plants when I travel.", options:["neighbor","brother","teacher"], correct:0, explain:"“Neighbor” es la persona que vive cerca, no necesariamente un familiar." } },
    { id:'v-facil-3', word:'Tired', translation:'Cansado · sin energía',
      ...
      quiz:{ prompt:"After the trip, I felt very ___.", options:["tired","happy","young"], correct:0, explain:"“Tired” describe falta de energía." } },
    { id:'v-facil-4', word:'Kitchen', translation:'Cocina · donde cocinas',
      ...
      quiz:{ prompt:"She is cooking in the ___.", options:["kitchen","garden","office"], correct:0, explain:"Cocinar ocurre en la “kitchen”." } },
  ...
  medio: [
    { id:'v-medio-1', word:'Reluctant', translation:'Reacio · con poca disposición',
      ...
      quiz:{ prompt:"He was ___ to try the new food.", options:["reluctant","excited","fast"], correct:0, explain:"“Reluctant” = con poca disposición o duda." } },
    { id:'v-medio-2', word:'Overwhelmed', translation:'Abrumado · con demasiado encima',
      ...
      quiz:{ prompt:"With so much to do, he felt ___.", options:["overwhelmed","bored","proud"], correct:0, explain:"“Overwhelmed” describe sentirse con demasiado encima." } },
    { id:'v-medio-3', word:'Assumption', translation:'Suposición · algo que se da por hecho',
      ...
      quiz:{ prompt:"Don't make ___ without checking the facts.", options:["assumptions","breakfast","neighbors"], correct:0, explain:"“Assumption” es algo que se supone sin confirmar." } },
    { id:'v-medio-4', word:'Consequently', translation:'En consecuencia · como resultado',
      ...
      quiz:{ prompt:"She was late; ___, she missed the bus.", options:["consequently","yesterday","friendly"], correct:0, explain:"“Consequently” conecta una causa con su resultado." } },
  ...
  avanzado: [
    { id:'v-avz-1', word:'Ubiquitous', translation:'Omnipresente · que está en todas partes',
      ...
      quiz:{ prompt:"Coffee shops are almost ___ in this city.", options:["ubiquitous","reluctant","tired"], correct:0, explain:"“Ubiquitous” = presente en todas partes." } },
    { id:'v-avz-2', word:'Nuance', translation:'Matiz · diferencia sutil de significado',
      ...
      quiz:{ prompt:"The two words are similar, but there's a slight ___.", options:["nuance","kitchen","weekend"], correct:0, explain:"“Nuance” es una diferencia sutil de significado." } },
    { id:'v-avz-3', word:'Contentious', translation:'Polémico · que genera desacuerdo',
      ...
      quiz:{ prompt:"Immigration is a ___ issue in many countries.", options:["contentious","tired","ubiquitous"], correct:0, explain:"“Contentious” describe algo que genera desacuerdo." } },
    { id:'v-avz-4', word:'Ambivalent', translation:'Ambivalente · con sentimientos encontrados',
      ...
      quiz:{ prompt:"He felt ___ about accepting the job.", options:["ambivalent","overwhelmed","achieve"], correct:0, explain:"“Ambivalent” = con sentimientos encontrados, ni a favor ni en contra del todo." } },
